...
import {usePokemons, usePokemonsList} from "../../shared/api/getPokemonList.ts";
...
const columns: TableColumnsType<PokemonTable> = [
    { title: 'Имя', dataIndex: 'name', key: 'name', align: 'center', width: '10%' },
    {
        title: 'Стандартный',
    ...
    { title: 'Вес', dataIndex: 'weight', key: 'weight', align: 'center', width: '5%' },
    { title: 'Вид', dataIndex: 'species', key: 'species', align: 'center', width: '20%' },
    Table.EXPAND_COLUMN,
];
...
const MainPokemonTable: FC = () => {
    ...
    const {data: pokemonMainInfo, isLoading:pokemonIsLoading} = usePokemons(pagination.current ?? 1, pagination.pageSize ?? 20, pagination.total ?? 20);
    ...
    return (
        <div>
            <Table
                ...
                columns={columns}
                expandable={{
                    expandedRowRender: (record) => <PokemonForm name={record.name} img={record.img}/>,
                }}
